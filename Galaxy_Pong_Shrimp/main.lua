...
--Paddle rendering player 1
require 'PaddleP1'
--Paddle rendering player 2
require 'PaddleP2'
--Background class
require 'Background'
...
function love.load()
    ...
    player1 = PaddleP1(10, 30, 10, 24)
    player2 = PaddleP2(VIRTUAL_WIDTH - 20, VIRTUAL_HEIGHT - 30, 10, 24)
...
function love.draw()
    ...
    -- displays the label of the player
