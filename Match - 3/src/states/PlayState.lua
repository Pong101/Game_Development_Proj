...
function PlayState:swapTiles(tile1, tile2, reverseSwap)
...
function PlayState:render()
    ...
    -- if board has no matches, render a text and background rect
    if self.noMatches then
        ...
        love.graphics.setFont(gFonts['medium'])
        love.graphics.printf('THERE ARE NO MATCHES AVAILABLE! RESETTING BOARD.',
            0, self.noMatchLabelY, VIRTUAL_WIDTH, 'center')
    end
end