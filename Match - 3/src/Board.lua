...
function Board:init(x, y, level)
    ...
    self.y = y
    self.matches = {}
    self.colorsCount = math.min(10, level + 5)
    self.colors = self:getRandomColors(self.colorsCount)
...
function Board:initializeTiles()
    ...
    for tileY = 1, 8 do
        ...
        for tileX = 1, 8 do
            ...
            table.insert(self.tiles[tileY], Tile(tileX, tileY, self.colors[math.random(self.colorsCount)], variety))
        end
    end
    ...
    for x = 1, 8 do
        for y = 8, 1, -1 do
            ...
            if not tile then
                ...
                local tile = Tile(x, y, self.colors[math.random(self.colorsCount)], variety)
                tile.y = -32
                self.tiles[y][x] = tile
...
function Board:getRandomColors(colorsCount)
    local colors = {}
...
-- function to delete whole row
function Board:delRow(y)
    local match = {}
...
-- function to delete whole column
function Board:delColumn(x)
    local match = {}
